...
static char *workModeEnum[] = {"无模式", "鲜嫩蒸", "营养蒸", "高温蒸", "微波蒸", "澎湃蒸", "快热", "风焙烤", "焙烤", "风扇烤", "强烤烧", "烤烧", "快速预热", "果蔬烘干", "EXP", "微波烤", "煎烤", "底加热", "空气炸", "微波", "eco", "手动加湿烤", "加湿烤-焙烤", "加湿烤-风焙烤", "加湿烤-强烤烧", "加湿烤-烤烧", "蒸汽炸", "大蒸汽", "预留", "预留", "预留", "预留", "发酵", "干燥", "杀菌", "除垢", "保温", "解冻", "清洁", "复热"};
