...
void evdev_read(lv_indev_drv_t * drv, lv_indev_data_t * data)
{
    ...
    data->point.x = drv->disp->driver->hor_res - evdev_root_y;
    data->point.y = evdev_root_x;
#endif

    data->state = evdev_button;
    //printf("%s 2,rotated:%d,hor_res:%d,ver_res:%d,x:%d,y:%d\n",__func__,drv->disp->driver->rotated,drv->disp->driver->hor_res,drv->disp->driver->ver_res,data->point.x,data->point.y);
