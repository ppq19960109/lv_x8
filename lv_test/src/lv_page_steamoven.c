...
static lv_obj_t * lv_hood_item_create(lv_obj_t * parent, const void * img_src, const void * text_img_src,
                                      lv_obj_t ** img_out)
{
...
void lv_page_steamoven_init(lv_obj_t * page)
{
    ...
    lv_obj_t * left_steam_oven =
        lv_hood_item_create(cont_row, themesImagesPath "left_steam_oven_background.png",
    ...
    lv_obj_t * right_steam = lv_hood_item_create(cont_row, themesImagesPath "right_steam_background.png",
