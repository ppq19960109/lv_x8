...
#define LV_DRAW_COMPLEX 1
    ...
    *Caching has LV_SHADOW_CACHE_SIZE^2 RAM cost*/
    #define LV_SHADOW_CACHE_SIZE 18

    /* Set number of maximally cached circle data.
    * The circumference of 1/4 circle are saved for anti-aliasing
    * radius * 4 bytes are used per circle (the most often used radiuses are saved)
    * 0: to disable caching */
    #define LV_CIRCLE_CACHE_SIZE 18
 ...
 */
#define LV_LAYER_SIMPLE_BUF_SIZE          (9 * 1024)
 ...
 *0: to disable caching*/
#define LV_IMG_CACHE_DEF_SIZE 3072
 ...
 *0 mean no caching.*/
#define LV_GRAD_CACHE_DEF_SIZE 3072
...
#define LV_DISP_ROT_MAX_BUF (480 * 854 * 2)
...
#define LV_USE_100ASK_PAGE_MANAGER                      1
    ...
    #define LV_100ASK_PAGE_MANAGER_COSTOM_ANIMARION     1
